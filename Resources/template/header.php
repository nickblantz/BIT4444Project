...
function generate_header($page_name) {
	...
	echo "<div class='col-md-2 col-sm-2 d-none d-sm-block justify-left pl-0'><a href='" . redirect_prefix('index') . "'><img height='56' src='" . redirect_prefix('Resources/images/logo.png') . "' /></a></div>";
